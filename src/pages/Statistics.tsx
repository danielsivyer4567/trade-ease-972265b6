...
export default function StatisticsPage() {
  ...
  return <AppLayout>
      <div className="p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mx-0 px-[5px] py-0">
          {teamData.map(team => <Card key={team.name}>
              <CardHeader>
              ...
              <CardContent>
                <dl className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <dd className={`font-medium ${team.defects <= 5 ? 'text-green-600' : team.defects <= 10 ? 'text-yellow-600' : 'text-red-600'}`}>
                      {team.defects}
                    </dd>
                  </div>
                </dl>
