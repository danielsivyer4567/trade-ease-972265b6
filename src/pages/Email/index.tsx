...
export default function Email() {
  ...
  const handleAddField = () => {
    ...
    setFormFields([...formFields, { id: newId, label: "New Field", required: false }]);
  };

  const handleUpdateField = (index: number, field: { id: string; label: string; required: boolean }) => {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input 
                    ...
                    value={formStyleOptions.primaryColor}
                    onChange={(e) => setFormStyleOptions({...formStyleOptions, primaryColor: e.target.value})}
                  />
                  <Input 
                    type="text"
                    value={formStyleOptions.primaryColor}
              ...
              <div className="space-y-2">
                ...
                <Input 
                  id="button-text"
                  value={formStyleOptions.buttonText}
                  onChange={(e) => setFormStyleOptions({...formStyleOptions, buttonText: e.target.value})}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input 
                  id="form-width"
                  value={formStyleOptions.formWidth}
                  onChange={(e) => setFormStyleOptions({...formStyleOptions, formWidth: e.target.value})}
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  onClick={() => copyToClipboard(generateFormCode(), 'code')}
