  ...
  return <AppLayout>
      <div className="space-y-8">
        <div className="flex items-center gap-3 mb-4 px-[240px] mx-[199px]">
          ...
          <h2 className="text-xl font-semibold text-zinc-950">Blue Team Calendar</h2>
        </div>
        ...
        <section>
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            day: "h-16 w-full p-2 font-normal aria-selected:bg-blue-600 aria-selected:text-white hover:bg-gray-100 rounded-md",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="p-4">
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  <h4 className="font-medium text-gray-700 mb-2">Insurance Documents</h4>
                  <p className="text-2xl font-bold text-blue-600">{documentCount.insurance}</p>
                  <p className="text-sm text-gray-500">documents uploaded</p>
                </div>
                <div className="border rounded-lg p-4">
                  <h4 className="font-medium text-gray-700 mb-2">General Documents</h4>
                  <p className="text-2xl font-bold text-blue-600">{documentCount.general}</p>
                  <p className="text-sm text-gray-500">documents uploaded</p>
                </div>
                <div className="border rounded-lg p-4">
                  <h4 className="font-medium text-gray-700 mb-2">Job Related Documents</h4>
                  <p className="text-2xl font-bold text-blue-600">{documentCount.jobRelated}</p>
                  <p className="text-sm text-gray-500">documents uploaded</p>
                </div>
              </div>
            </Card>
        ...
        <section>
          <h2 className="text-xl font-semibold text-blue-600 mb-4">Team Time Off</h2>
          <Card className="p-4">
