...
const ADVANCED_JOB_TYPES = [
  "Kitchen Renovation", "Bathroom Remodel", "Deck Construction", 
  "House Painting", "Flooring Installation", "Plastering", 
  ...
  return (
    <>
      ...
      <PurchaseDialogBase
        ...
        title="Advanced Auto-Purchase Lead Settings"
        description="Configure targeted auto-purchase with advanced filters (max 3 per week)"
        enabled={enabled}
        onEnabledChange={setEnabled}
        onSave={onSave}
        onCancel={() => onOpenChange(false)}
        toggleLabel="Enable Advanced Auto-Purchase"
        maxWidth="550px"
      >
        ...
        <MaxLeadsPerWeekSelect
          ...
          id="advanced-max-per-week"
          helpText="Maximum of 3 leads can be auto-purchased per week"
        />
        ...
        <PostcodeSelector
          ...
          helpText="Auto-purchase leads only from these postal codes"
        />
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {preferences.serviceAreas.map((area) => (
              <div 
                key={area}
