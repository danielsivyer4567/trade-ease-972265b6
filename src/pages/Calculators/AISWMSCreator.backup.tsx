...
<div class="footer">
  ...
  return (
    <AppLayout>
      ...
      {/* Header Section */}
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 text-white p-6 mb-6">
      ...
      <div className="container mx-auto max-w-6xl px-4 mb-6">
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
          <div className="flex items-center">
            <AlertTriangle className="h-5 w-5 text-blue-400 mr-3 flex-shrink-0" />
            <div>
