...
export const WalkieTalkie = ({ jobId }: WalkieTalkieProps) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Button 
        className={`bg-green-500 hover:bg-green-600 text-white font-bold uppercase tracking-wider flex items-center gap-2 h-10 ${
          isMobile ? "px-3 text-xs min-w-0" : "min-w-[200px] h-12"
        }`}
        ...
        aria-label="Walkie talkie transmission button"
      >
