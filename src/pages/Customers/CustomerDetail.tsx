...
export default function CustomerDetail() {
  ...
  return <AppLayout>
      <div className="p-6 max-w-5xl space-y-6 py-[240px] my-[178px] mx-[214px] px-[20px]">
        ...
        <CustomerDetails customer={customer} notes={notes} jobHistory={jobHistory} onAddNote={handleAddNote} onCreateJob={handleCreateJob} onCreateQuote={handleCreateQuote} />
      </div>
    </AppLayout>;
}