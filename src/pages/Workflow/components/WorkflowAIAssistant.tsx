    ...
    return (
      <div 
        ...
        style={{
          ...
          borderTop: `1px solid ${workflowDarkMode ? '#383838' : '#eaeaea'}`,
          borderBottom: `1px solid ${workflowDarkMode ? '#383838' : '#eaeaea'}`,
          borderLeft: `1px solid ${workflowDarkMode ? '#383838' : '#eaeaea'}`,
          borderRight: 'none',
  ...
  return (
    <div 
      ...
      style={{
        ...
        bottom: '20px',
        backgroundColor: workflowDarkMode ? DARK_SECONDARY : '#fff',
        borderTop: `1px solid ${workflowDarkMode ? 'rgba(165, 149, 255, 0.3)' : '#eaeaea'}`,
        borderBottom: `1px solid ${workflowDarkMode ? 'rgba(165, 149, 255, 0.3)' : '#eaeaea'}`,
        borderLeft: `1px solid ${workflowDarkMode ? 'rgba(165, 149, 255, 0.3)' : '#eaeaea'}`,
        borderRight: 'none',
        borderTopLeftRadius: '8px',
        borderBottomLeftRadius: '8px',
