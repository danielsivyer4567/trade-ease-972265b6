...
export const ConnectedPhonesList: React.FC<ConnectedPhonesListProps> = ({
  ...
  return <div className="space-y-4">
      ...
      {connectedNumbers.length > 0 ? <div className="space-y-2">
          {connectedNumbers.map((number, index) => <div key={index} className="flex justify-between items-center p-3 bg-white rounded-md border">
        ...
        </div> : <div className="p-4 border rounded-md bg-gray-50 text-center text-gray-500">
