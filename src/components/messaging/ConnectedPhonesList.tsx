  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-medium text-slate-800">Connected Phone Numbers</h3>
      ...
      {connectedNumbers.length > 0 ? (
        ...
        <div className="p-6 border rounded-lg bg-gray-50 text-center text-gray-500 border-dashed border-gray-300">
