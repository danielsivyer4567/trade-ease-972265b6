        ...
        <Card className="p-4 bg-slate-200">
          ...
          <form onSubmit={handleIncidentSubmit} className="space-y-4">
            <div>
              ...
              <select className="w-full rounded-md border border-input bg-background px-3 h-10" value={incidentReport.type} onChange={e => setIncidentReport({
              ...incidentReport,
              type: e.target.value
            })} required>
            ...
            <div>
              ...
              <Input type="text" value={incidentReport.location} onChange={e => setIncidentReport({
              ...incidentReport,
            ...
            <div>
              ...
              <select className="w-full rounded-md border border-input bg-background px-3 h-10" value={incidentReport.severity} onChange={e => setIncidentReport({
              ...incidentReport,
            ...
            <div>
              ...
              <Textarea value={incidentReport.description} onChange={e => setIncidentReport({
              ...incidentReport,
