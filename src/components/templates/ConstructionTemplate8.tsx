...
const ConstructionTemplate8: React.FC<ConstructionQuoteTemplateProps> = ({
  ...
  const editor = useTemplateEditor({
    defaultComponents: [
      ...
      { id: 'project-breakdown', type: 'project-breakdown', title: 'Project Breakdown', order: 3 },
      { id: 'summary', type: 'summary', title: 'Summary', order: 4 },
      { id: 'terms', type: 'terms', title: 'Terms', order: 5 },
      { id: 'signature', type: 'signature', title: 'Signature', order: 6 },
    ]
  });
